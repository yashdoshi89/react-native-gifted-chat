      ...
      <View style={[styles.container, this.props.containerStyle]}>
        <List style={{ width: width * .7 }}>
            ...
            <Item style={{borderColor:'#D5D8E1', borderBottomWidth: 0.5,}}>
              ...
              <Text style={{color:'#1E2023', fontSize:13,}}>$25 in Uber credits</Text>
               </Button>
             </Item>
            ...
            <Item style={{borderColor:'#D5D8E1', borderBottomWidth: 0.5, marginTop:20,height:70,}}>
             ...
             <Item>
               ...
               <Text style={{  textAlign: 'center', flex:1,  marginTop: -5, color:'#FFFFFF', fontSize:14, }}>Only $99 - Buy Now</Text>
                </Button>
              </Item>
         </List>
       </View>
